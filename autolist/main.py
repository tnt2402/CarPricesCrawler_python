...
# Example usage
url = "https://www.autolist.com/api/v2/search?ads=true&include_total_price_change=true&include_time_on_market=true&include_relative_price_difference=true&latitude=0&limit=20&longitude=0&page="

all_results = crawl_pages(url)
# print(all_results)
write_to_csv(all_results, 'cars_autolist.csv')
